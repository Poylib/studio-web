...
const steps = [
  {
    ...
    title: 'Meeting',
    description:
      'Initial consultation and site analysis to understand the core requirements.',
  },
  {
    id: '02',
    title: 'Shooting',
    description:
      'On-site photography focusing on light, shadow, and material textures.',
  },
  {
    id: '03',
    title: 'Backup',
    description:
      'Secure data management with triple redundancy across physical and cloud storage.',
  },
  {
    id: '04',
    title: 'Retouch',
    description:
      'Meticulous post-processing to enhance the atmosphere while maintaining authenticity.',
  },
  {
    id: '05',
    title: 'Confirm',
    description:
      "Collaborative review process to ensure the vision aligns with the client's needs.",
  },
  {
    id: '06',
    title: 'Delivery',
    description:
      'Final delivery of high-resolution assets optimized for various media formats.',
  },
];
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-16 md:mb-24 flex flex-col md:flex-row md:items-end justify-between gap-8">
          ...
          <p className="text-neutral-400 max-w-md text-sm md:text-base pb-2">
            Our workflow is designed to ensure precision and artistic integrity
            at every stage.
          </p>
        </div>
