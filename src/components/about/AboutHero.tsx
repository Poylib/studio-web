...
export default function AboutHero() {
    ...
    return (
        <section ref={containerRef} className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-neutral-950 px-6 md:px-12">
                    ...
                    <div className="md:col-span-4 md:col-start-9">
                        ...
                        >
                            ...
                            <p className="text-neutral-400 leading-relaxed text-sm md:text-base font-mono">
                                SOCON exists in the space between the built environment and the lens.
                                We strip away the noise to reveal the silent, structural core of every space.
                                <br /><br />
                                [ EST. 2024 ]
                            </p>
                        </motion.div>
