    ...
    <footer className="w-full bg-neutral-950 py-12 text-neutral-400 border-t border-neutral-900">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed">
              Spatial design studio crafting immersive environments and
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a
                  href="mailto:hello@socon.studio"
                  className="hover:text-white transition-colors"
                >
                  hello@socon.studio
                </a>
        ...
        <div className="mt-12 flex flex-col items-center justify-between border-t border-neutral-900 pt-8 text-xs md:flex-row">
          <p>&copy; 2024 Socon Studio. All rights reserved.</p>
          <p className="mt-2 md:mt-0">Business NO. 196-87-02906</p>
        </div>
      </div>
    </footer>
  );
