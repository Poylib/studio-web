...
const services: ServiceItem[] = [
    {
        ...
        description: "Capturing the essence of space through light and composition.",
        details: [
    ...
    },
    {
        ...
        color: "bg-zinc-600",
        image: "https://images.unsplash.com/photo-1533518463841-d62e1fc91373?q=80&w=2400&auto=format&fit=crop",
    },
    {
        id: "interior-video",
...
export default function PriceSection() {
    ...
    return (
        <section ref={containerRef} className="relative min-h-screen bg-background text-foreground py-32 px-4 md:px-12">
                    ...
                    <div className="border-t border-white/10 pt-16 space-y-12">
                        ...
                        <div className="bg-surface p-8 border border-white/5">
                            <p className="text-sm text-secondary font-mono">
                                * All prices exclude VAT. Tax invoices are available upon request.
                            </p>
                        </div>
                    </div>
                </div>
