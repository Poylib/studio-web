...
export default function WorkDetail({ work, nextWork }: WorkDetailProps) {
  ...
  return (
    <article
      ref={containerRef}
      className="min-h-screen bg-neutral-950 text-neutral-200 selection:bg-white selection:text-black"
    >
      {/* Hero Section */}
          ...
          <div className="lg:col-span-4 space-y-12">
            <div className="space-y-8 sticky top-32">
              ...
              <div>
                ...
                <p className="text-neutral-400 leading-relaxed text-balance">
                  {work.description}
                </p>
              </div>
            </div>
      ...
      {nextWork && (
        <Link
          ...
          className="block group relative overflow-hidden h-[60vh] w-full"
        >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6">
            <span className="text-sm font-mono text-neutral-400 uppercase tracking-widest mb-4">
              Next Project
            </span>
